...
public class SwaggerConfig {
    ...
    @Value("${steam.openapi.dev-url}")
    private String devUrl;

    @Value("${steam.openapi.prod-url}")
    ...
    public OpenAPI openAPI() {
        ...
        Info info = new Info()
                .title("API service document for store steam game")
                .version("v1.0.0")
                .contact(contact)
    ...
    public GroupedOpenApi groupedOpenApi() {
        return GroupedOpenApi.builder()
                .group("api-service-game")
                .packagesToScan("io.store.steam.controller")
                .build();
    }
